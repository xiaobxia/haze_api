 ...
 */
@Service
public class Bill99ServiceImpl implements Bill99Service {

    private static final Logger log = LoggerFactory.getLogger(Bill99ServiceImpl.class);
    ...
    public Map<String, Object> getBindCardRequest(Map<String, String> paramMap) {
        log.info("Bill99Service getBindCardRequest start");
        log.info("Bill99Service getBindCardRequest paramMap=" + JSON.toJSONString(paramMap));
        ...
        log.info("Bill99Service getBindCardRequest userId=" + userId);
        try {
            ...
            log.info("Bill99Service getBindCardRequest requestUrl=" + requestUrl);
            log.info("Bill99Service getBindCardRequest dataMap=" + JSON.toJSONString(beanReq));
    ...
    //        resultMap = YeepayApiUtil.httpExecuteResult(dataMap, userId, requestUrl, "getBindCardRequest");
            ...
            log.info("Bill99Service getBindCardRequest resultMap=" + (resultMap != null ? JSON.toJSONString(resultMap) : "null"));
            if (resultMap == null) {
            ...
            log.info("Bill99Service getBindCardRequest userId=" + userId + " status=" + (orderStatus != null ? orderStatus.toString() : "null"));
            //待短验
            ...
            log.info("Bill99Service getBindCardRequest userId=" + userId + " errorcode=" + resultMap.get("errorcode") + " errormsg=" + resultMap.get("errormsg"));
    ...
    public ResultModel<Map<String, Object>> getBindCardConfirm(YPBindCardConfirmReq bindCardConfirmReq) {
        log.info("Bill99Service getBindCardConfirm start");
        log.info("Bill99Service getBindCardConfirm paramMap=" + JSON.toJSONString(bindCardConfirmReq));
        ...
        log.info("Bill99Service getBindCardConfirm userId=" + userId);
...
//        Map<String, Object> resultMap = YeepayApiUtil.httpExecuteResult(bindCardConfirmReq.getDataMap(), userId, requestUrl, "getBindCardConfirm");
        ...
        log.info("Bill99Service getBindCardConfirm userId=" + userId + " errorcode=" + resultMap.get("errorcode") + " errormsg=" + resultMap.get("errormsg"));
        if (resultMap.containsKey("errorcode") && !"".equals(resultMap.get("errorcode"))) {
        ...
        log.info("Bill99Service getBindCardConfirm userId=" + userId + " status=" + orderStatus);
        //绑卡
    ...
    public Map<String, Object> getBindCardSmsCode(Map<String, String> paramMap) {
        log.info("Bill99Service getBindCardSmsCode paramMap=" + JSON.toJSONString(paramMap));
        Map<String, Object> resultMap = new HashMap<>();
        resultMap.put("code", "500");
        resultMap.put("msg", "请求异常");
        //商户编号
        ...
        log.info("Bill99Service getBindCardSmsCode userId=" + userId);
        Map<String, String> dataMap = new HashMap<>();
        dataMap.put("merchantno", merchantNo);
        dataMap.put("requestno", requestNo);
        log.info("Bill99Service getBindCardSmsCode dataMap=" + JSON.toJSONString(dataMap));
        ...
        log.info("Bill99Service getBindCardSmsCode resultMap=" + (resultMap != null ? JSON.toJSONString(resultMap) : "null"));
        ...
        Object orderStatus = resultMap.get("status");
        log.info("Bill99Service getBindCardSmsCode userId=" + userId + " status=" + (orderStatus != null ? orderStatus.toString() : "null"));
        //待短验
        ...
        log.info("Bill99Service getBindCardSmsCode userId=" + userId + " errorcode=" + resultMap.get("errorcode") + " errormsg=" + resultMap.get("errormsg"));
        if (resultMap.containsKey("errorcode") && !"".equals(resultMap.get("errorcode"))) {
            resultMap.put("code", "400");
            resultMap.put("msg", resultMap.get("errormsg"));
            newOutOrder.setStatus(OutOrders.STATUS_OTHER);
    ...
    public ResultModel updateUserBankInfo(Map<String, String> paramMap) throws Exception {
        log.info("Bill99Service updateUserBankInfo start");
        log.info("Bill99Service updateUserBankInfo paramMap=" + JSON.toJSONString(paramMap));
        ...
        if (bankCardByCardNo == null) {
            ...
            log.info("Bill99Service updateUserBankInfo userId=" + userId + " new flag=" + flag);
...
//            pool.execute(new DtThread(UserPushUntil.BANKAPPROVE, Integer.valueOf(userId), null, new Date(), userService, pushUserService, borrowOrderService, null));
            ...
            log.info("Bill99Service updateUserBankInfo userId=" + userId + " old flag=" + flag);
        ...
        log.info("Bill99Service updateUserBankInfo end resultMap=" + JSON.toJSONString(resultModel));
        return resultModel;
    }
    ...
    public Map<String, Object> getWithdrawRequest(Map<String, String> paramMap) throws Exception {
        log.info("Bill99Service getWithdrawRequest start");
        log.info("Bill99Service getWithdrawRequest paramMap=" + JSON.toJSONString(paramMap));
...
//        pairs.put("desc", PropertiesConfigUtil.get("APP_NAME") + "放款");
        ...
        outOrders.setStatus(OutOrders.STATUS_WAIT);
        log.info("Bill99Withdraw before insert into outOrder,outOrder no is:" + outOrders.getOrderNo());
        outOrdersService.insert(outOrders);
        log.info("Bill99Withdraw after insert into outOrder,outOrder no is:" + outOrders.getOrderNo());

        //发送https请求
        ResponseBody result = null;
        try{
            result = Bill99Util.unsealMsg(paramMap);
            log.info("Bill99Withdraw result=" + result);
        }catch (Exception e){
            log.error("request Bill99 error:{}",e);
        }
//        // 更新订单
        ...
        if (result != null) {
            if(result.getErrorCode().equals("0000")) {
                ...
                resultMap = new HashMap<>();
                resultMap.put("code", "400");
                resultMap.put("msg", "代付失败" + result.getErrorCode() + ":【" + result.getErrorMsg() + "】");
    ...
    public Map<String, Object> getUnSendBindCardRequest(Map<String, String> paramMap) {
        log.info("Bill99Service getUnSendBindCardRequest start");
        log.info("Bill99Service getUnSendBindCardRequest paramMap=" + JSON.toJSONString(paramMap));
        ...
        log.info("Bill99Service getUnSendBindCardRequest requestUrl=" + requestUrl);
        log.info("Bill99Service getUnSendBindCardRequest dataMap=" + JSON.toJSONString(dataMap));
...
//        resultMap = YeepayApiUtil.httpExecuteResult(dataMap, userId, requestUrl, "getUnSendBindCardRequest");
        ...
        log.info("Bill99Service getUnSendBindCardRequest resultMap=" + (resultMap != null ? JSON.toJSONString(resultMap) : "null"));
        if (resultMap == null) {
        ...
        Object orderStatus = resultMap.get("status");
        log.info("Bill99Service getUnSendBindCardRequest userId=" + userId + " status=" + (orderStatus != null ? orderStatus.toString() : "null"));
        ...
        log.info("Bill99Service getUnSendBindCardRequest userId=" + userId + " errorcode=" + resultMap.get("errorcode") + " errormsg=" + resultMap.get("errormsg"));
        if (resultMap.containsKey("errorcode") && !"".equals(resultMap.get("errorcode"))) {
            resultMap.put("code", "400");
            resultMap.put("msg", resultMap.get("errormsg"));
            newOutOrder.setStatus(OutOrders.STATUS_OTHER);
    ...
    public Map<String, Object> getRechargeSmsCode(Map<String, String> paramMap) {
        log.info("Bill99Service getRechargeSmsCode start");
        log.info("Bill99Service getRechargeSmsCode paramMap=" + JSON.toJSONString(paramMap));
        Map<String, Object> resultMap = new HashMap<>();
        resultMap.put("code", "500");
        resultMap.put("msg", "请求异常");
        //商户编号
        ...
        String requestNo = YeepayApiUtil.formatString(paramMap.get("requestNo"));
        String userId = YeepayApiUtil.formatString(paramMap.get("userId"));
        log.info("Bill99Service getRechargeSmsCode userId=" + userId);
        Map<String, String> dataMap = new HashMap<>();
        dataMap.put("merchantno", merchantNo);
        dataMap.put("requestno", requestNo);
        dataMap.put("advicesmstype", "MESSAGE");
        log.info("Bill99Service getRechargeSmsCode dataMap=" + JSON.toJSONString(dataMap));
...
//        resultMap = YeepayApiUtil.httpExecuteResult(dataMap, userId, PayConstants.AUTOPAY_RESENDSMS_URL, "getRechargeSmsCode");
        try{
            ...
            log.error("getRechargeSmsCode post Bill99 error:{}",e);
        }

        log.info("Bill99Service getRechargeSmsCode resultMap=" + (resultMap != null ? JSON.toJSONString(resultMap) : "null"));
        if (resultMap == null) {
            resultMap = new HashMap<>();
            resultMap.put("code", "400");
            resultMap.put("msg", "操作异常，请刷新页面重试");
    ...
    public ResultModel<Map<String, Object>> getRechargeConfirm(Map<String, String> paramMap) {
        ...
        log.info("Bill99Service getRechargeConfirm start");
        log.info("Bill99Service getRechargeConfirm paramMap=" + JSON.toJSONString(paramMap));
...
//        String requestUrl = PayConstants.AUTOPAY_CONFIRM_URL;
        ...
        log.info("Bill99Service getRechargeConfirm userId=" + userId);
        Map<String, String> dataMap = new HashMap<>();
        dataMap.put("merchantno", merchantNo);
        dataMap.put("requestno", requestNo);
...
//        log.info("Bill99Service getRechargeConfirm requestUrl=" + requestUrl);
        log.info("Bill99Service getRechargeConfirm dataMap=" + JSON.toJSONString(dataMap));
...
//        Map<String, Object> resultMap = YeepayApiUtil.httpExecuteResult(dataMap, userId, PayConstants.AUTOPAY_CONFIRM_URL, "getRechargeConfirm");
        try{
            ...
            log.error("getRechargeConfirm post Bill99 error:{}",e);
        }
        log.info("Bill99Service getRechargeConfirm resultMap=" + (resultMap != null ? JSON.toJSONString(resultMap) : "null"));
        if (resultMap == null) {
            newOutOrder.setStatus(OutOrders.STATUS_OTHER);
            outOrdersService.updateByOrderNo(newOutOrder);
            resultModel.setCode(ErrorCode.ERROR_400.getCode());
        ...
        log.info("Bill99Service getRechargeConfirm userId=" + userId + " errorcode=" + resultMap.get("errorcode") + " errormsg=" + resultMap.get("errormsg"));
        if (resultMap.containsKey("errorcode") && !"".equals(resultMap.get("errorcode"))) {
            resultModel.setCode(ErrorCode.ERROR_400.getCode());
        ...
        if (!"null".equals(orderStatus)) {
            log.info("Bill99Service getRechargeConfirm userId=" + userId + " status=" + orderStatus);
            ...
            log.info("Bill99Service getRechargeConfirm userId=" + userId + " status=null");
        }
        return resultModel;
    }
    ...
    public PageResultModel<YPBatchPayResultModel> getYBPayResult(YPBatchPayResultReq ypBatchPayResultReq) {
        log.info("Bill99Service getYBPayResult ypBatchPayResultReq=" + JSON.toJSONString(ypBatchPayResultReq));
        ...
        log.info("Bill99Service getYBPayResult 签名之前的源数据=" + hmacStr);
        //获得签名
        Map<String, Object> signMap = YeepayUtil.getSign(hmacStr);

        log.info("Bill99Service getYBPayResult 经过md5和数字证书签名之后的数据=" + signMap.get("sign").toString());
        ...
        log.info("Bill99Service getYBPayResult 完整xml请求报文==>:" + document.asXML());

        log.info("Bill99Service getYBPayResult requestUrl=" + requestUrl);

        String responseMsg = CallbackUtils.httpRequest(requestUrl, document.asXML(), "POST", "gbk", "text/xml ;charset=gbk", false);
        log.info("Bill99Service getYBPayResult 服务器响应xml报文:" + responseMsg);
        ...
        log.info("Bill99Service getYBPayResult resultMap=" + JSONObject.toJSONString(responseHeadMap));
    ...
    public ResultModel<FuiouRepayResultModel> getFuiouRepayResult(YPRepayRecordReq ypRepayRecordReq, String userId) {
        log.info("Bill99Service getYBRepayResult start");
        log.info("Bill99Service getYBRepayResult paramMap=" + JSON.toJSONString(ypRepayRecordReq));
...
//        String requestUrl = ;
        ...
        log.info("Bill99Service getYBRepayResult reqData=" + JSON.toJSONString(ypRepayRecordReq));
        //调用易宝api,获取返回map
//        Map<String, Object> resultMap = YeepayApiUtil.httpExecuteResult(dataMap, userId, requestUrl, "getYBRepayResult");
        ...
        if (resultMap == null) {
            log.info("Bill99Service getYBRepayResult resultMap= null");
            resultModel.setCode(ErrorCode.ERROR_400.getCode());
            resultModel.setMessage("查询失败，请重试");
            return resultModel;
        }
        log.info("Bill99Service getYBRepayResult resultMap= " + JSON.toJSONString(resultMap));
        resultModel.setSucc(true);
