 ...
 */
@Controller
@RequestMapping(value = "/fuiouBindCard")
public class FuiouBindCardController extends BaseController {

    private static final Logger logger = LoggerFactory.getLogger(FuiouBindCardController.class);
    ...
    public String bindNewCard(HttpServletRequest request,Model model) {
        ...
        //到添加银行卡页面
        return "userinfo/fuiou/firstUserBank";
    }
    ...
    public String showUserBankCardInfo(HttpServletRequest request, HttpServletResponse response,
        ...
        //到展示银行卡页面
        return "userinfo/fuiou/showUserBank";
    }
