...
public class YoumiLoanStatus {
    ...
    /**
     * 可以再次申请借款的时间，此时间之前将不在请求用户过滤接口（值如：2018-12-25） 审核成功后传空
     */
    ...
    public YoumiLoanStatus() {
    }

    public YoumiLoanStatus(String order_no, String order_status, String amount, String term, String term_type, String remark, String can_loan_time, String updated_at, Integer installment_term, Integer installment_interval, Integer installment_amount) {
