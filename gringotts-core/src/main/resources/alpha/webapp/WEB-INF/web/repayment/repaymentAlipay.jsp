...
<div class="ui-page ui-page-theme-a ui-page-active" data-role="page"  style="background:#fff;">
    ...
    <div class="sure-tc" style="height: 6.25rem;">
        ...
        <div class="btn-both clearfix" style="padding:0 0.5rem;">
            <a data-ajax="false" href="javascript:;" onclick="querySureTc();" class="btn sure-btn" style="width:7rem;float:left;border:1px solid #FFA30D;height:2rem;line-height:2rem;">已支付</a>
            <a href="javascript:;" onclick="closeSureTc();" class="btn sure-btn" style="width:7rem;float:right;background:none;border:1px solid #FFA30D; color:#fff !important;height:2rem;line-height:2rem;">未支付</a>
        </div>
    </div>
    <!-- 遮罩层 -->
    <div class="cover"></div>
