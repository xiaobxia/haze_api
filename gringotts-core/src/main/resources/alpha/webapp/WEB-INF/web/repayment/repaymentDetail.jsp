    ...
    <div class="wrapper">
            ...
            <ul class="jk-list">
                ...
                <li>
                    ...
                    <p class="xy">
                        <em>借款合同</em>
                        <span>
                            <a href="${path}/credit-loan/agreement?borrowId=${bo.id}&userId=${bo.userId}&appName=${appName}" rel="external">《个人借款协议》</a>
                            <!--<a href="${path}/agreement/platformServiceNew?borrowId=${bo.id}&userId=${bo.userId}&appName=${appName}" rel="external">《平台服务协议》</a>-->
                        </span>
                    </p>
                    <p>
                        <span>
                            <!-- <a href="${path}/agreement/withholdAuthorization?borrowId=${bo.id}&userId=${bo.userId}&appName=${appName}" rel="external" style="margin-left: 3.4rem;">《授权扣款协议》</a> -->
                        </span>
                    </p>
                </li>
        ...
        <div class="sure-tc">
            ...
            <div class="btn-both clearfix" style="padding:0 0.5rem;">
                <a data-ajax="false" href="${path}/repayment/repay-choose?id=${bo.id}" class="btn sure-btn" style="width:7rem;float:left;border:1px solid #FFA30D;height:2rem;line-height:2rem;">去还款</a>
                <a href="javascript:;" onclick="closeSureTc();" class="btn sure-btn" style="width:7rem;float:right;background:none;border:1px solid #FFA30D; color:#fff !important;height:2rem;line-height:2rem;">取消</a>
            </div>
        </div>
        <!-- 遮罩层 -->
        <div class="cover"></div>
