...
<script type="text/javascript">
    ...
    function getWithholdRequest(){
        ...
        if (gloabelBank_id !== "") {
            ...
            openAjax('${path}/yeepay/repayWithholdRequest?userId=${bo.userId}',data,WithholdRequestCallback);
        }else {
    ...
    function getWithholdSmsCode(){
        if(checkRequestNo()){
            ...
            openAjax('${path}/yeepay/repayWithholdSmscode?userId=${bo.userId}', data,WithholdTokenMsgCallback);
        }
    }
    //易宝支付短信验证码回调
    ...
    function query_result(id,no){
        ...
        timer = setInterval(function(){
            ...
            flag = false;
            $.post('${path}/yeepay/query-withhold',{id:id,orderNo:no},function(data){
                if(data.code == "0"){
