...
function againBankCard(){
	    	...
	    	data.id=$("#cardId").val();
			openAjax('${path}/fuiouBindCard/credit-card/validBorrowOrder?deviceId=${deviceId}&mobilePhone=${mobilePhone}', data,resultSave);
}
function resultSave(data){
	if(data.code=="0"){
		window.location.href ="${path}/fuiouBindCard/credit-card/updateUserBank?deviceId=${deviceId}&mobilePhone=${mobilePhone}";
   	}
	else if(data.code=="-2"){
