...
<div class="ui-page ui-page-theme-a ui-page-active" data-role="page"  style="background:#fff;">
  ...
  <!-- main start -->
  <div class="wrapper">
    <!-- <div class="butt"><a href="javascript:void(0);">下载</a></div> -->
    <div class="agreement">
      <h2>个人借款协议</h2>
      <br>
      <p><em>编号：</em><span>**订单生成后可见**</span></p>
      <p><em>甲方（借款人）：</em><span>${user.realname}</span></p>
      <p><em>身份证号码：</em><span>${user.idNumber}</span></p>
      <p><em>乙方（出借人）：</em><span>**订单生成后可见**</span></p>
      <p><em>身份证号码：</em><span>**订单生成后可见**</span></p>
      <br>
      <p>借款标的明细</p>
      <br>
