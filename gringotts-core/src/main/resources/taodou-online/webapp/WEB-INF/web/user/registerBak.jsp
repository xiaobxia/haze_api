...
<form method="POST" id="registerForm" class="ui-mobile-viewport ui-overlay-a">
    <div class="ui-page ui-page-theme-a ui-page-active" data-role="page" tabindex="0" style="min-height: 640px;">
        <!-- main start -->
            ...
            <div class="register">
                <ul class="info-list">
                    ...
                    <li>
                        ...
                        <img id="imgCap" style="width: 5.22rem; height: auto;float: right;margin-right: -0.9rem;" src="<%=path %>/captcha.svl?RCaptchaKey=${RCaptchaKey}" onclick="this.src='<%=request.getContextPath() %>/captcha.svl?RCaptchaKey=${RCaptchaKey}&d='+new Date()*1" valign="bottom" alt="点击更新" title="点击更新">
    ...
    <div class="ui-loader ui-corner-all ui-body-a ui-loader-default"><div><span class="ui-icon-loading"></span><h1>loading</h1></div></div>
</form>
