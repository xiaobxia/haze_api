            ...
            <ul class="zl_info tk_new sqxf">
                <li>
                    <a rel="external" href="javascript:;">
                        <span>支付金额<strong><fmt:formatNumber pattern='###,###,##0.00'
                                                            value="${(repayment.repaymentAmount - repayment.repaymentedAmount) / 100.00}"/></strong><em>元</em></span>
                    </a>
                </li>
                <li>
                ...
                <li class="nobd gain-yzm gain-yzm1" style="display: none">
                    <a rel="external" href="javascript:;">
                        ...
                        <div class="yzm clickToken" onclick="getWithholdRequest();" id="yzm"
                             style="text-indent: 16px;float: left;width:25%;">点击获取
                        </div>
                    </a>
                </li>
            </ul>
...
<script type="text/javascript">
    ...
    function getWithholdRequest() {
        ...
        if (gloabelBank_id !== "") {
            ...
            openAjax('${path}/fuiou/repayWithholdRequest?userId=${bo.userId}', data, WithholdRequestCallback);
        } else {
    ...
    function getWithholdSmsCode() {
        if (checkRequestNo()) {
            ...
            openAjax('${path}/fuiou/repayWithholdSmscode?userId=${bo.userId}', data, WithholdTokenMsgCallback);
        }
    }
    ...
    jQuery(document).ready(function ($) {
        ...
        $('#mima-btn-1').click(function (event) {
            ...
            $.post('${path}/fuiou/repayWithholdConfirm', {
                id: '${bo.id}',
    ...
    function query_result(id, no) {
        ...
        timer = setInterval(function () {
            ...
            flag = false;
            $.post('${path}/fuiou/query-withhold', {id: id, orderNo: no}, function (data) {
                if (data.code == "0") {
