...
<!--         </div> -->
        ...
        <div class="wrapper">
          ...
          <a href="javascript:history.go(-1);" class="js-btn2 mt60" id="again-btn">返回</a>
...
function againBankCard(){
	    	...
	    	data.id=$("#cardId").val();
			openAjax('${path}/chanpayBindCard/credit-card/validBorrowOrder?deviceId=${deviceId}&mobilePhone=${mobilePhone}', data,resultSave);
}
function resultSave(data){
	if(data.code=="0"){
		window.location.href ="${path}/chanpayBindCard/credit-card/updateUserBank?deviceId=${deviceId}&mobilePhone=${mobilePhone}";
   	}
	else if(data.code=="-2"){
